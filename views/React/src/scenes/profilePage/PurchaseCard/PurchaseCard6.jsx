...
import SmashDong300 from '../../../assets/image/SmashDong3000.png';
import Buy300 from '../../../assets/image/Buy3000.png';
...
export default function PurchaseCard6() {
  ...
  return (
    <div>
      <StyledCard onClick={() => handleClickOpen(4600)}>
        <CardContent className="first-content">

        </CardContent>
        <CardContent className="second-content">
